...
$("#btn1").on("click", function () {
    ...
    let great_stamina = Math.round(energy_need * 0.075);
    let great_inherit_stamina = Math.round(energy_need * 0.035);
    //let message = `${stamina_need}`
    // jQuery���g���ĉ�ʂɃ��b�Z�[�W��\������
    $("#tBox").val(stamina_need_round);
    $("#tBox2").val(blue_stamina);
    $("#tBox3").val(white_stamina);
    $("#tBox4").val(great_stamina);
    $("#tBox5").val(great_inherit_stamina);
});